    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: '6px' }}>Welcome back</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Sign in to continue to InstaStyle</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '28px' }}>
          ...
          <Link to="/register" style={{ fontWeight: 600, fontSize: '0.9rem' }}>Sign up</Link>
        </div>
      </motion.div>
    </div>
  );
